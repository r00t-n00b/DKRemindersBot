...
def test_list_no_reminders(main_module):
    msg, upd, ctx = _mk_private("/list")
...
def test_list_only_recurring(main_module):
    _seed_recurring_only(main_module)
    msg, upd, ctx = _mk_private("/list")
    main_module.InlineKeyboardButton = _Btn
    main_module.InlineKeyboardMarkup = _Markup
    asyncio.run(main_module.list_command(upd, ctx))
...
def test_list_mixed(main_module):
    _seed_mixed_reminders(main_module)
    msg, upd, ctx = _mk_private("/list")
    main_module.InlineKeyboardButton = _Btn
    main_module.InlineKeyboardMarkup = _Markup
    asyncio.run(main_module.list_command(upd, ctx))
