def test_next_week(main_module, fixed_now):
    ...
    # next week = понедельник следующей недели 10:00 по умолчанию
...
def test_next_month(main_module, fixed_now):
    ...
    # 28.11 -> 28.12 (если такой день есть) 10:00
    assert dt.strftime("%d.%m %H:%M") == "28.12 10:00"
...
def test_weekend_weekday_workday(main_module, fixed_now):
    ...
    assert dt4.strftime("%d.%m %H:%M") == "29.11 10:00"
