...
from reminder_message_store import clear_reminder_message_keyboards_impl, delete_old_snoozed_reminder_messages_impl, delete_other_reminder_messages_impl, get_reminder_messages_impl, register_reminder_message_impl
...
async def delete_other_reminder_messages(
    bot,
    *,
    reminder_id: int,
    keep_chat_id: int,
    ...
    await delete_other_reminder_messages_impl(
        bot,
