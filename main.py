...
def _build_remind_command_deps():
    return SimpleNamespace(
        ...
        MSG_REMIND_USAGE=MSG_REMIND_USAGE,
        _create_single_reminder_from_line=_create_single_reminder_from_line,
        _format_bulk_result=_format_bulk_result,
        ...
        create_recurring_template=create_recurring_template,
        dispatch_remind_creation=dispatch_remind_creation,
        drop_optional_bulk_header=drop_optional_bulk_header,
        extract_after_command=extract_after_command,
        ...
        is_recurring_missing_dash_candidate=is_recurring_missing_dash_candidate,
        logger=logger,
        looks_like_recurring=looks_like_recurring,
        ...
        msg_recurring_missing_dash=msg_recurring_missing_dash,
        ...
        parse_recurring=parse_recurring,
        parse_with_optional_default_time=parse_with_optional_default_time,
        reject_group_remind_target_prefix_if_needed=reject_group_remind_target_prefix_if_needed,
        resolve_remind_target_and_args=resolve_remind_target_and_args,
