...
async def help_command(update: Update, context: CTX) -> None:
    ...
    text = dedent("""
        ...
        Удаление recurring:
        бот спросит, удалить только ближайшее или всю серию.
        ...
        Можно выбрать обычное личное напоминание или напоминание до события.

        После срабатывания:
        доступны кнопки +20 минут, +1 час, +3 часа, завтра,
        следующий понедельник, кастомная дата и Mark complete.
    """).strip()
